...
class HeadHunterLocators:
    ...
    LOCATOR_HH_UPDATE_BUTTON = (By.CSS_SELECTOR, "button[data-qa='resume-update-button']")
    ...
    LOCATOR_HH_RESUMEUPDATE_BUTTON = (By.CSS_SELECTOR, "button[data-qa='resume-update-button']")
